...
<title>Become a volunteer :: Miss Career</title>
					...
					<div class="col-md-6">
							...
							<div class="col-md-12">
								<div class="row">
									...
									<div class="col-md-5">
											<div class="form-group">
												<select class="form-control" placeholder="Area Code" name="countryCode" id="">
														<option data-countryCode="RW" value="250" Selected>Rwanda (+250)</option>
										...
										<div class="col-md-4">
											...
											<div class="col-md-12">
													<div class="form-group">
														Please, tell us areas of your interest of where you would ever be a volunteer in
														according to your skills of passion.
													</div>
											</div>
									</div>
									...
									<div class="col-md-12">
											<div class="form-group">
												<select class="form-control" placeholder="Select Type">
