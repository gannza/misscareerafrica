                        ...
                        <div class="nav-header">
                            ...
                            <nav id="fh5co-menu-wrap" role="navigation">
                                <ul class="sf-menu" id="fh5co-primary-menu">
                                    ...
                                    <li><a class="apply" style="color: #000;font-weight:bold" href="candidate-application">APPLY NOW</a></li>
									<li><a class="buy-ticket" style="color: #000;font-weight:bold" href="buy-ticket">BUY TICKET</a></li>
                                    <li><a class="can-voting" style="color: #000;font-weight:bold" href="selected-candidates">VOTE PRESELECTED CANDIDATES</a></li>
                                    ...
                                    <li><a style="color: #000;font-weight:bold" href="#">MORE....</a>
                                        <ul class="fh5co-sub-menu">
								...
								<div class="col-12">
										...
										<h1 class="text-center">
											<span style="text-align: center;">
												...
												<span class="ard-subtitle mb-2 h1"> <b>Power and Future into the hands of a girl ....</b></span>
											</span>
										</h1>
			...
			<div class="row mt-5">
				...
				<div class="col-md-3">
						...
						<ul class="link">
								...
								<li><a style="color: #000;font-weight:bold" href="scholarship">MCA Scholarship</a></li>
                                <li><a style="color: #000;font-weight:bold" href="fund">MCA Fund</a></li>
                                <li><a style="color: #000;font-weight:bold" href="book-mca">Book MCA</a></li>
						</ul>
					</div>
