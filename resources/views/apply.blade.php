        ...
        <div id="fh5co-page">
            ...
            <div id="fh5co-blog-section">
                <div class="container" id="contact">
                    ...
                    <form id="applay_form" method="post" action="" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="level_education"
                                                    name="level_education" placeholder="Level">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="former_school_attended">Former School Attended</label>
                                                <input type="text" class="form-control" id="former_school_attended"
                                                    name="former_school_attended" placeholder="Former School Attended">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="education_background">Briefly describe your education
                                                    background (500 Max)</label>
                                                <textarea type="text" id="education_background"
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="current_occupation"
                                                    name="current_occupation" placeholder="Current Occupation">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="q2">Q2. What is your next five years career plans? (500
                                                    Max)</label>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="q5">Q5. How will you use the title to influence your
                                                    community and africa at large once crowned Miss Career Africa? (500
                                                    Max)</label>
                                                <textarea type="text" id="q5" name="q5" maxlength="501"
                                                    class="form-control" placeholder=""></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="q6">Q6. Tell us why you deserve to be crowned Miss Career
                                                    Africa? (500 Max)</label>
                                                <textarea type="text" id="q6" name="q6" maxlength="501"
                                                    class="form-control" placeholder=""></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="q7">Q7. Briefly describe your recent career achievements you
                                                    are proud of? (500 Max)</label>
                                                <textarea type="text" id="q7" name="q7" maxlength="501"
                                                    class="form-control" placeholder=""></textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group row">
                                                <div class="col-md-6">
                                                    <label>
                                                        Kindly consider selecting a picture of your best choice ever,
                                                        professional one and make sure it’s high definition. If the
                                                        picture is not of that type,
                                                ...
                                                <div class="col-md-6">
                                                    <img id="output_image" class="mt-3 img-fluid img-rounded" />
                                                </div>
                                            </div>
                                        </div>
                                        <br />
